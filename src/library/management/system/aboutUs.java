...
public class aboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public aboutUs() {
            ...
            JLabel l6 = new JLabel("Developed By : D3");
            l6.setFont(new Font("Trebuchet MS", Font.BOLD, 40));
            l6.setBounds(70, 198, 600, 35);
            contentPane.add(l6);

            JLabel l7 = new JLabel("TANAY SHRIVASTAVA");
            l7.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l7.setBounds(70, 260, 600, 34);
            contentPane.add(l7);

            JLabel l8 = new JLabel("VAIBHAV VARMA");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 30));
            l8.setBounds(70, 290, 600, 34);
            contentPane.add(l8);

            JLabel l9 = new JLabel("VEER DUTTA");
